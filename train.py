...
def train_model(
    ...
    optimizer = optim.AdamW(model.parameters(), lr=learning_rate, weight_decay=weight_decay) #AdamW incluye regularización L2 correctamente, lo que mejora la generalización y el dice score respecto a Adam
